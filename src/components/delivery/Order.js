...
function Order() {
  ...
  return (
    <div>
      ...
      <div className="delivery-content-wrapper">
        <div style={{ width: "30rem" }}>
          ...
          <div className="address-wrapper">
            <div className="address-main">용인시 기흥구 서천동 1</div>
            <div class="address-input">전자정보대학 331호</div>
          </div>
        </div>
      </div>
      ...
      <div className="delivery-content-wrapper">
        <div style={{ width: "30rem" }}>
          ...
          <div className="friend-row-box my-pay-info">
            ...
            <div className="friends-pay-money">2,330원</div>
          </div>
          ...
          <div className="friend-row-box">
            ...
            <div className="friends-pay-money">8,830원</div>
          </div>
          <div className="friend-row-box">
            <div
              className="friends-profile-img"
      ...
      <button type="button" id="group-delivery-btn" onClick={goToPay}>
        결제 및 정산 요청하기
      </button>
    </div>
  );
